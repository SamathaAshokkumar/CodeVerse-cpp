#include<iostream>
 ...
 //W - Not in Spanning Tree, B - Selected for

 enum MyColor {W,B};

 struct Edge
 {
 int u,v; //Index of starting and terminating
 ...
 //Initialize the size and the vertex'
 Graph(int,int,int [][MAX]);


 //weight matrix and starting vertex index
